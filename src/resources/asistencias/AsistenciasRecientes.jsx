  ...
  return (
    <Box p={3}>
      ...
      <HelperCard
        title="Guía rápida"
        items={[
          "Usa los botones superiores para moverte entre los últimos días hábiles (los futuros están bloqueados).",
          "Selecciona un curso para cargar la tabla del día elegido.",
          "El bloque de resumen valida rápido cuántos presentes, ausentes o tardes se cargaron.",
          "Descarga la planilla (Excel) o el PDF si necesitas compartir la información.",
        ]}
      />
