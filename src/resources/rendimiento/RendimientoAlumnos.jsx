        ...
        >
          <Stack spacing={2}>
            ...
            <Typography variant="body2" color="text.secondary">
              Podés generar un informe pedagógico personalizado con inteligencia artificial
              analizando el rendimiento del alumno en el período seleccionado para compartirlo con
              las familias o el equipo docente.
            </Typography>
